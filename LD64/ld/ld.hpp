...
struct Fixup 
{
	enum TargetBinding UNSIGNED_BF { bindingNone, bindingByNameUnbound, bindingDirectlyBound, bindingByContentBound, bindingsIndirectlyBound };
	enum Cluster UNSIGNED_BF { k1of1, k1of2, k2of2, k1of3, k2of3, k3of3, k1of4, k2of4, k3of4, k4of4, k1of5, k2of5, k3of5, k4of5, k5of5 };
	enum Kind	UNSIGNED_BF {	kindNone, kindNoneFollowOn, 
					// grouping
...
{
public:
	enum Scope UNSIGNED_BF { scopeTranslationUnit, scopeLinkageUnit, scopeGlobal };
	enum Definition UNSIGNED_BF { definitionRegular, definitionTentative, definitionAbsolute, definitionProxy };
	enum Combine UNSIGNED_BF { combineNever, combineByName, combineByNameAndContent, combineByNameAndReferences };
	enum ContentType UNSIGNED_BF { typeUnclassified, typeZeroFill, typeCString, typeCFI, typeLSDA, typeSectionStart, 
	...
	enum SymbolTableInclusion UNSIGNED_BF { symbolTableNotIn, symbolTableNotInFinalLinkedImages, symbolTableIn,
								symbolTableInAndNeverStrip, symbolTableInAsAbsolute, 
								symbolTableInWithRandomAutoStripLabel };
	enum WeakImportState UNSIGNED_BF { weakImportUnset, weakImportTrue, weakImportFalse };
