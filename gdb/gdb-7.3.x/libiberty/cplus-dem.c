...
const struct demangler_engine libiberty_demanglers[] =
{
  ...
  ,
  {
    DELPHI_DEMANGLING_STYLE_STRING,
    delphi_demangling,
    "DELPHI style demangling"
  }
  ,
  {
...
#define SCOPE_STRING(work) (((work->options & DMGL_JAVA) || (work->options & DMGL_DELPHI)) ? "." : "::")
...
cplus_demangle (const char *mangled, int options)
{
  ...
  if (GNU_V3_DEMANGLING || AUTO_DEMANGLING || DELPHI_DEMANGLING)
    {
