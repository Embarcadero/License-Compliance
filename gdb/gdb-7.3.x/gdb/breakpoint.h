...
enum enable_state
  {
    ...
    bp_startup_disabled, /* The eventpoint has been disabled during
			    ...
			    complete.  */
    bp_hand_call_disabled, /* EMBARCADERO LOCAL. The eventpoint has 
                been disabled while various mi commands update variables, 
                so that the hand calls for updating the variables 
...
/* EMBARCADERO Local: _NativeMain entry bkpt */
extern CORE_ADDR get_nativemain_entry_point (void);
