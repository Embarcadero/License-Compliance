...
/* EMBARCADERO Local: StopPipe control variables - see remote.c */
#ifdef USE_WIN32API
int stoppipe_enable = 0;
#endif
...
captured_main (void *data)
{
  ...
  /* Parse arguments and options.  */
  {
    ...
    enum {
      ...
      OPT_WINDOWS
#ifdef USE_WIN32API
      ,OPT_STOPPIPE /* EMBARCADERO LOCAL */
#endif
    };
...
#ifdef USE_WIN32API
      /* EMBARCADERO LOCAL: StopPipe option */
      {"pipestop", no_argument, 0, OPT_STOPPIPE},
#endif
      {0, no_argument, 0, 0}
    };
...
"), stream);
  ...
  /* EMBARCADERO LOCAL: StopPipe option */
  fputs_unfiltered (_("\
  --pipestop  Use pipe for receiving target stop requests on a separate thread.\n\
"), stream);
  /* END EMBARCADERO LOCAL */
#endif  
  fputs_unfiltered (_("\n\
