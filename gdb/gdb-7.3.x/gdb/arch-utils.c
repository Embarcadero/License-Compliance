...
int
default_pass_value_as_reference (struct gdbarch *gdbarch,
				 struct value *function, struct type *type)
{
  /* Default is to ignore the function and just check the argument type.  */
  return default_stabs_argument_has_addr (gdbarch, type);
}
/* EMBARCADERO Local: end Delphi ABI */

/* EMBARCADERO Local: begin calling conventions */
int
default_calling_convention_supported (struct gdbarch *gdbarch,
				      struct value *function)
{
  /* Default is to assume all calling conventions are supported.  */
  return default_calling_convention_supported (gdbarch, function);
}

const char *
default_calling_convention_string (struct gdbarch *gdbarch,
				   struct value *function)
{
  /* Default is to assume no special calling convention.  */
  return NULL;
}
...
/* EMBARCADERO Local: default argument pusher for fCall Wrapper */
int
default_fcw_argument_push (struct gdbarch *gdbarch)
{
  return 0;
}
