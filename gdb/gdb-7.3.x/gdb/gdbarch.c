...
struct gdbarch
{
  ...
  /* EMBARCADERO Local: function call wrapper support */
  ...
  gdbarch_calling_convention_supported_ftype *calling_convention_supported;
  gdbarch_calling_convention_string_ftype *calling_convention_string;
...
struct gdbarch startup_gdbarch =
{
  ...
  default_fcw_argument_push, /* EMBARCADERO Local: fcw_argument_push */
  /* EMBARCADERO Local: Delphi ABI */
  default_pass_value_as_reference, /* pass_value_as_reference */
  /* EMBARCADERO Local: begin calling conventions */
  default_calling_convention_supported,
               ...
               struct gdbarch_tdep *tdep)
{
  ...
  /* EMBARCADERO Local: begin initialize missing fields */
  gdbarch->solib_symbols_extension = 0;
  gdbarch->has_dos_based_file_system = 0;
  /* EMBARCADERO Local: end initialize missing fields */
  /* EMBARCADERO Local: function call wrapper support */
  gdbarch->fcw_argument_push = default_fcw_argument_push;
  /* EMBARCADERO Local: Delphi ABI */
  gdbarch->pass_value_as_reference = default_pass_value_as_reference;
  /* EMBARCADERO Local: begin calling conventions */
  gdbarch->calling_convention_supported = default_calling_convention_supported;
  gdbarch->calling_convention_string = default_calling_convention_string;
  /* EMBARCADERO Local: end calling conventions */
  /* gdbarch_alloc() */
  return gdbarch;
}
...
verify_gdbarch (struct gdbarch *gdbarch)
{
  ...
  /* Skip verify of fcw_argument_push, invalid_p == 0 */
  /* EMBARCADERO Local: Delphi ABI */
  /* Skip verify of pass_value_as_reference, invalid_p == 0 */
  /* EMBARCADERO Local: begin calling conventions */
  /* Skip verify of calling_convention_supported, invalid_p == 0 */
  /* Skip verify of calling_convention_string, invalid_p == 0 */
  /* EMBARCADERO Local: end calling conventions */
...
gdbarch_dump (struct gdbarch *gdbarch, struct ui_file *file)
{
  ...
  /* EMBARCADERO Local: function call wrapper support */
  fprintf_unfiltered (file,
                      "gdbarch_dump: fcw_argument_push = <%s>\n",
                      host_address_to_string (gdbarch->fcw_argument_push));
  fprintf_unfiltered (file,
  ...
  fprintf_unfiltered (file,
                      "gdbarch_dump: fcw_argument_push = <0x%lx>\n",
                      (long) gdbarch->fcw_argument_push);
  /* EMBARCADERO Local: end fCall Wrapper function arguments pusher */
  /* EMBARCADERO Local: begin Delphi ABI */
  fprintf_unfiltered (file,
                      "gdbarch_dump: gdbarch_pass_value_as_reference_p() = %d\n",
                      gdbarch_pass_value_as_reference_p (gdbarch));
  fprintf_unfiltered (file,
                      "gdbarch_dump: pass_value_as_reference = <0x%lx>\n",
                      (long) gdbarch->pass_value_as_reference);
  /* EMBARCADERO Local: end Delphi ABI */
  /* EMBARCADERO Local: begin calling conventions */
  fprintf_unfiltered (file,
                      "gdbarch_dump: calling_convention_supported = <0x%lx>\n",
                      (long) gdbarch->calling_convention_supported);
  fprintf_unfiltered (file,
                      "gdbarch_dump: calling_convention_string = <0x%lx>\n",
                      (long) gdbarch->calling_convention_string);
  /* EMBARCADERO Local: end calling conventions */
...
/* EMBARCADERO Local: fCall Wrapper function arguments pusher */
int
gdbarch_fcw_argument_push (struct gdbarch *gdbarch)
{
  gdb_assert (gdbarch != NULL);
  gdb_assert (gdbarch->fcw_argument_push != NULL);
  if (gdbarch_debug >= 2)
    fprintf_unfiltered (gdb_stdlog, "gdbarch_fcw_argument_push called\n");
  return gdbarch->fcw_argument_push (gdbarch);
}

void 
set_gdbarch_fcw_argument_push (struct gdbarch *gdbarch, gdbarch_fcw_argument_push_ftype *fcw_argument_push)
{
  gdbarch->fcw_argument_push = fcw_argument_push;
}
/* End of EMBARCADERO Local: fCall Wrapper function arguments pusher */

/* EMBARCADERO Local: begin Delphi ABI */
int
gdbarch_pass_value_as_reference_p (struct gdbarch *gdbarch)
{
  gdb_assert (gdbarch != NULL);
  return gdbarch->pass_value_as_reference != NULL;
}

int
gdbarch_pass_value_as_reference (struct gdbarch *gdbarch,
				 struct value *function,
				 struct type *value_type)
{
  gdb_assert (gdbarch != NULL);
  gdb_assert (gdbarch->pass_value_as_reference != NULL);
  if (gdbarch_debug >= 2)
    fprintf_unfiltered (gdb_stdlog, "gdbarch_pass_value_as_reference called\n");
  return gdbarch->pass_value_as_reference (gdbarch, function, value_type);
}

void
set_gdbarch_pass_value_as_reference (struct gdbarch *gdbarch,
				     gdbarch_pass_value_as_reference_ftype *pass_value_as_reference)
{
  gdbarch->pass_value_as_reference = pass_value_as_reference;
}
/* EMBARCADERO Local: begin Delphi ABI */
...
/* Return 1 if the function's calling convention is supported on the
   this architecture.  */
int
gdbarch_calling_convention_supported (struct gdbarch *gdbarch,
				      struct value *function)
{
  gdb_assert (gdbarch != NULL);
  gdb_assert (gdbarch->calling_convention_supported != NULL);
  if (gdbarch_debug >= 2)
    fprintf_unfiltered (gdb_stdlog, "gdbarch_calling_convention_supported called\n");
  return gdbarch->calling_convention_supported (function);
}

void
set_gdbarch_calling_convention_supported (struct gdbarch *gdbarch,
    gdbarch_calling_convention_supported_ftype *calling_convention_supported)
{
  gdbarch->calling_convention_supported = calling_convention_supported;
}

/* Return the string corresponding to the calling convention.  */
const char *
gdbarch_calling_convention_string (struct gdbarch *gdbarch,
				   struct value *function)
{
  gdb_assert (gdbarch != NULL);
  gdb_assert (gdbarch->calling_convention_string != NULL);
  if (gdbarch_debug >= 2)
    fprintf_unfiltered (gdb_stdlog, "gdbarch_calling_convention_string called\n");
  return gdbarch->calling_convention_string (function);
}

void
set_gdbarch_calling_convention_string (struct gdbarch *gdbarch,
    gdbarch_calling_convention_string_ftype *calling_convention_string)
{
  gdbarch->calling_convention_string = calling_convention_string;
}
/* EMBARCADERO Local end calling conventions */
