...
/* EMBARCADERO Local: turned on in solib.c after main lib loaded */ 
int trust_readonly = 0;
		     ...
		     LONGEST len)
{
  ...
  /* Try the local executable files and solibs in first, if "trust-readonly-sections" is set.  */
  /* EMBARCADERO Local: this code used only after main program lib loaded -
     big improvement for any ops which using target memory reads often */ 
...
generic_mourn_inferior (void)
{
  ...
  /* Cleanup the fcall breakpoints and remove them from the bp_stats lists now,
     or else breakpoint_init_inferior will try to delete them also. */
