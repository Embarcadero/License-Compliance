...
/* On targets without fCall Wrapper support default argument pusher just do nothing */
...
extern void set_gdbarch_fcw_argument_push (struct gdbarch *gdbarch, gdbarch_fcw_argument_push_ftype *fcw_argument_push);
