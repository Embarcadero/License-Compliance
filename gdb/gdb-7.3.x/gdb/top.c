...
print_gdb_version (struct ui_file *stream)
{
  ...
  /* EMBARCADERO LOCAL build date */
  fprintf_filtered (stream, "GNU gdb %s%s (%s)\n", PKGVERSION, version, build_date);
  ...
  fprintf_filtered (stream,
	  	    "\twith modifications copyright 2017 Embarcadero Technologies, Inc.\n");
  fprintf_filtered (stream,
	  	    "\tlinked with iconv (GNU libiconv 1.14) written by Bruno Haible,\n"
