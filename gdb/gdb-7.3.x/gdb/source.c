  ...
  for (i = 0; i < sals.nelts; i++)
      ...
      if (sal.symtab == 0)
	{
	  ...
	  if (!mi_out_style)
	    ...
	    {
	      ui_out_field_core_addr (uiout, "start", gdbarch, sal.pc);
	      ui_out_field_core_addr (uiout, "end", gdbarch, 0);
	       ...
	       && find_line_pc_range (sal, &start_pc, &end_pc))
	{
	  ...
	  if (!mi_out_style)
	    ...
	    {
	      ui_out_field_core_addr (uiout, "start", gdbarch, start_pc);
	      ui_out_field_core_addr (uiout, "end", gdbarch, end_pc);
	...
	{
	  ui_out_field_core_addr (uiout, "start", get_current_arch (), 0);
	  ui_out_field_core_addr (uiout, "end", get_current_arch (), 0);
	  ui_out_field_int (uiout, "line", sal.line);
	  ui_out_field_string (uiout, "file", sal.symtab->filename);
	}
    }
