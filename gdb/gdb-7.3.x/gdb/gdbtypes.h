...
enum type_code
  {
    ...
    /* EMBARCADERO LOCAL: property support. */
    TYPE_CODE_PROPERTY,		/* Property type */
...
enum type_flag_value
{
  ...
  TYPE_FLAG_DELPHI_CLASS = (1 << 19),
  TYPE_FLAG_DELPHI_RECORD = (1 << 20),
  TYPE_FLAG_DELPHI_RETURN = (1 << 21),
...
/* EMBARCADERO LOCAL: The class is a Delphi class.  */
#define TYPE_DELPHI_CLASS(t) (TYPE_MAIN_TYPE (t)->flag_delphi_class)

/* EMBARCADERO LOCAL: The struct is a Delphi record.  */
#define TYPE_DELPHI_RECORD(t) (TYPE_MAIN_TYPE (t)->flag_delphi_record)

/* EMBARCADERO LOCAL: The struct is a Delphi return type.  */
#define TYPE_DELPHI_RETURN(t) (TYPE_MAIN_TYPE (t)->flag_delphi_return)

/* EMBARCADERO LOCAL: The function follows the Delphi ABI.  */
#define TYPE_DELPHI_ABI(t) (TYPE_MAIN_TYPE (t)->flag_delphi_ABI)

/* EMBARCADERO LOCAL: The pointer is a Delphi dynamic array.  */
#define TYPE_DELPHI_DYNARRAY(t) (TYPE_MAIN_TYPE (t)->flag_delphi_dynarray)
...
struct main_type
{
  ...
  /* EMBARCADERO LOCAL: This flag marks a class as being a Delphi class.  */
  unsigned int flag_delphi_class : 1;
  /* EMBARCADERO LOCAL: This flag marks a struct as being a Delphi record.  */
  unsigned int flag_delphi_record : 1;
  /* EMBARCADERO LOCAL: This flag marks a struct as being a Delphi return
     type.  */
  unsigned int flag_delphi_return : 1;
  /* EMBARCADERO LOCAL: This flag marks a function as adhering to the
     Delphi ABI.  */
  unsigned int flag_delphi_ABI : 1;
  /* EMBARCADERO LOCAL: This flag marks a pointer as being a Delphi dynamic
     array.  */
  unsigned int flag_delphi_dynarray : 1;
  ...
  union 
  {
	...
	char *physname;
	 ...
	 defined.  */
      ...
      /* For a function or member type, this is 1 if the argument is marked
         as being a metaclass.  Metaclass arguments should require special
         handling during function calls.  */
      unsigned int metaclass : 1;

      /* EMBARCADERO Local: Delphi nested functions */
      /* For a function or member type, this is 1 if the argument is marked
	 as being a frameptr for a nested function in Delphi.  Frameptr
	 arguments should require special handling during function calls
	 and for evaluating locals defined in the outer function.  */
      unsigned int frameptr : 1;
  ...
  union type_specific
  {
    ...
    /* Decimal scale for support of DW_AT_decimal_scale */
    /* It is expected, that this field will be used only for integer types
       otherwise it may damage other union members */
    int decimal_scale;
	...
	struct fn_field
	  {
	    ...
	    /* EMBARCADERO Local: Delphi class methods */
	    unsigned int is_metaclass:1;
	    /* EMBARCADERO Local: Delphi nested functions */
	    unsigned int is_frameptr:1;
...
#define VOFFSET_STATIC 1
    ...
    /* EMBARCADERO LOCAL begin dwarf extensions */
    /* For classes, structures, and unions, a description of each property,
	See http://docwiki.embarcadero.com/RADStudio/XE4/en/Property
	(NOTE: implements is wrong in doc).  */
	...
	unsigned int has_getter:1;
	unsigned int has_setter:1;
...
#define TYPE_DECIMAL_SCALE(thistype) TYPE_MAIN_TYPE(thistype)->type_specific.decimal_scale
...
/* EMBARCADERO Local: Delphi class methods */
#define FIELD_METACLASS(thisfld) ((thisfld).metaclass)
/* EMBARCADERO Local: Delphi nested functions */
#define FIELD_FRAMEPTR(thisfld) ((thisfld).frameptr)
...
/* EMBARCADERO Local: Delphi class methods */
#define TYPE_FIELD_METACLASS(thistype, n) FIELD_METACLASS(TYPE_FIELD(thistype,n))
/* EMBARCADERO Local: Delphi nested functions */
#define TYPE_FIELD_FRAMEPTR(thistype, n) FIELD_FRAMEPTR(TYPE_FIELD(thistype,n))
...
/* EMBARCADERO Local: Delphi class methods */
#define TYPE_FN_FIELD_METACLASS(thisfn, n) ((thisfn)[n].is_metaclass)
/* EMBARCADERO Local: Delphi nested functions */
#define TYPE_FN_FIELD_FRAMEPTR(thisfn, n) ((thisfn)[n].is_frameptr)
...
#define PROP_FIELD_TYPE(thisprop) ((thisprop).type)
#define PROP_FIELD_NAME(thisprop) ((thisprop).name)
#define PROP_FIELD_READ_NAME(thisprop) ((thisprop).read.name)
#define PROP_FIELD_READ_PHYSNAME(thisprop) ((thisprop).read.physname)
#define PROP_FIELD_WRITE_NAME(thisprop) ((thisprop).write.name)
#define PROP_FIELD_WRITE_PHYSNAME(thisprop) ((thisprop).write.physname)
#define PROP_FIELD_INDEX(thisprop) ((thisprop).index)
#define PROP_FIELD_PRIVATE(thisprop) ((thisprop).is_private)
#define PROP_FIELD_PROTECTED(thisprop) ((thisprop).is_protected)
#define PROP_FIELD_PUBLIC(thisprop) ((thisprop).is_public)
#define PROP_FIELD_STATIC(thisprop) ((thisprop).is_static)
#define PROP_FIELD_GETTER(thisprop) ((thisprop).has_getter)
#define PROP_FIELD_SETTER(thisprop) ((thisprop).has_setter)

#define TYPE_PROP_FIELDS(thistype) TYPE_CPLUS_SPECIFIC(thistype)->prop_fields
#define TYPE_NPROP_FIELDS(thistype) TYPE_CPLUS_SPECIFIC(thistype)->nprop_fields
#define TYPE_PROP_FIELD(thistype, n) TYPE_CPLUS_SPECIFIC(thistype)->prop_fields[n]

#define TYPE_PROP_FIELD_TYPE(thistype, n) PROP_FIELD_TYPE(TYPE_PROP_FIELD(thistype, n))
#define TYPE_PROP_FIELD_NAME(thistype, n) PROP_FIELD_NAME(TYPE_PROP_FIELD(thistype, n))
#define TYPE_PROP_FIELD_READ(thistype, n) PROP_FIELD_READ(TYPE_PROP_FIELD(thistype, n))
#define TYPE_PROP_FIELD_WRITE(thistype, n) PROP_FIELD_WRITE(TYPE_PROP_FIELD(thistype, n))
#define TYPE_PROP_FIELD_INDEX(thistype, n) PROP_FIELD_INDEX(TYPE_PROP_FIELD(thistype, n))
#define TYPE_PROP_FIELD_PRIVATE(thistype, n) PROP_FIELD_PRIVATE(TYPE_PROP_FIELD(thistype, n))
#define TYPE_PROP_FIELD_PROTECTED(thistype, n) PROP_FIELD_PROTECTED(TYPE_PROP_FIELD(thistype, n))
#define TYPE_PROP_FIELD_PUBLIC(thistype, n) PROP_FIELD_PUBLIC(TYPE_PROP_FIELD(thistype, n))
#define TYPE_PROP_FIELD_STATIC(thistype, n) PROP_FIELD_STATIC(TYPE_PROP_FIELD(thistype, n))
#define TYPE_PROP_FIELD_GETTER(thistype, n) PROP_FIELD_GETTER(TYPE_PROP_FIELD(thistype, n))
#define TYPE_PROP_FIELD_SETTER(thistype, n) PROP_FIELD_SETTER(TYPE_PROP_FIELD(thistype, n))
...
/* EMBARCADERO LOCAL begin support for methods.  */
extern struct type *lookup_struct_elt_struct (struct type *, char *, int);

extern struct fn_field *lookup_struct_elt_fn_field (struct type *t,
						    char *name,
						    char *physname);

extern struct prop_field *lookup_struct_elt_prop_field (struct type *t,
						    	char *name);

extern void error_unknown_struct_elt (struct type *type, char *name);
/* EMBARCADERO LOCAL end support for methods.  */
...
extern int c_delphi_string_type (struct type *);
