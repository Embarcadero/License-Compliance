...
#define	yymaxdepth pname_maxdepth
#define	yyparse	pname_parse
#define	yylex	pname_lex
#define	yyerror	pname_error
#define	yylval	pname_lval
#define	yychar	pname_char
#define	yydebug	pname_debug
#define	yypact	pname_pact	
#define	yyr1	pname_r1			
#define	yyr2	pname_r2			
#define	yydef	pname_def		
#define	yychk	pname_chk		
#define	yypgo	pname_pgo		
#define	yyact	pname_act		
#define	yyexca	pname_exca
#define yyerrflag pname_errflag
#define yynerrs	pname_nerrs
#define	yyps	pname_ps
#define	yypv	pname_pv
#define	yys	pname_s
#define	yy_yys	pname_yys
#define	yystate	pname_state
#define	yytmp	pname_tmp
#define	yyv	pname_v
#define	yy_yyv	pname_yyv
#define	yyval	pname_val
#define	yylloc	pname_lloc
#define yyreds	pname_reds		/* With YYDEBUG defined */
#define yytoks	pname_toks		/* With YYDEBUG defined */
#define yyname	pname_name		/* With YYDEBUG defined */
#define yyrule	pname_rule		/* With YYDEBUG defined */
#define yylhs	pname_yylhs
#define yylen	pname_yylen
#define yydefred pname_yydefred
#define yydgoto	pname_yydgoto
#define yysindex pname_yysindex
#define yyrindex pname_yyrindex
#define yygindex pname_yygindex
#define yytable	 pname_yytable
#define yycheck	 pname_yycheck
...
static int
p_parse_escape (const char **string_ptr)
{
  int target_char;
  int c = *(*string_ptr)++;
  if (c_parse_backslash (c, &target_char))
      ...
      case '^':
	{
	  ...
	  if (c == '?')
	    ...
	    target_char = p_parse_escape (string_ptr);
	  else
	    target_char = c;
...
p_comp_to_string (struct demangle_component *result, int estimated_len)
{
  ...
  return cplus_demangle_print (DMGL_DELPHI | DMGL_PARAMS | DMGL_ANSI, result, estimated_len,
			       &err);
}
...
struct demangle_component *
p_demangled_name_to_comp (const char *demangled_name, const char **errmsg)
{
...
main (int argc, char **argv)
{
  ...
  if (argv[arg] == NULL)
	...
	result = p_demangled_name_to_comp (str2, &errmsg);
	if (result == NULL)
	  {
	    fputs (errmsg, stderr);
	    fputc ('\n', stderr);
    ...
    {
      result = p_demangled_name_to_comp (argv[arg], &errmsg);
      if (result == NULL)
	{
	  fputs (errmsg, stderr);
	  fputc ('\n', stderr);
