...
struct mi_cmd mi_cmds[] =
{
  ...
  { "data-info-line", { "info line", 1 }, NULL },
  ...
  /* EMBARCADERO LOCAL: cmd for getting the inferior's pid.  */
  { "pid-info", { NULL, 0 }, mi_cmd_pid_info },
  ...
  /* EMBARCADERO LOCAL DebugHook control */
  { "enable-debughook", { NULL, 0 }, mi_cmd_debughook_control},
  { NULL, }
};
