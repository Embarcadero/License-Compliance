...
/* Define DEBUG_PARSE to enable debugging of expressions.  */
...
end_arglist (void)
{
  ...
  DEBUG_PRINT(("   EXP: %s, arglist_len=%d\n", __FUNCTION__, arglist_len));
...
write_exp_elt_opcode (enum exp_opcode expelt)
{
  ...
  DEBUG_PRINT(("   EXP: %s(%s)\n", __FUNCTION__, op_name_standard(expelt)));
			  ...
			  int *oplenp, int *argsp)
{
  ...
  switch (i)
    ...
    /* EMBARCADERO LOCAL: add support of Pascal multi-dimensional arrays */
