...
print_gdb_version (struct ui_file *stream)
{
  ...
  fprintf_filtered (stream, "Copyright 2010 Free Software Foundation, Inc.\n");
  fprintf_filtered (stream, "\twith modifications copyright 2017 Embarcadero Technologies, Inc.\n");
...
/* EMBARCADERO Local: StopSocket mapped file - see main.c */
...
quit_force (char *args, int from_tty)
{
  ...
  /* EMBARCADERO Local: unlink StopSocket mapped file before exit */
