...
/* Values for is_a_field_of_this.  */
enum implicit_field_kinds
  {
    ifk_none,	    /* not a member of an implicit variable.  */
    ifk_this,	    /* a member of the implicit object parameter.  */
    ifk_frame,	    /* a member of the implicit frame structure.  */
    ifk_frameptr    /* a member of the implicit frameptr parameter.  */
  };
