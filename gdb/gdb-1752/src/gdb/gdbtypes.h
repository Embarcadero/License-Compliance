...
#define TYPE_FLAG_DELPHI_CLASS (1 << 19)
#define TYPE_DELPHI_CLASS(t)       (TYPE_FLAGS (t) & TYPE_FLAG_DELPHI_CLASS)

/* EMBARCADERO LOCAL: This flag marks a struct as being a Delphi record.  */
#define TYPE_FLAG_DELPHI_RECORD (1 << 20)
#define TYPE_DELPHI_RECORD(t)       (TYPE_FLAGS (t) & TYPE_FLAG_DELPHI_RECORD)

/* EMBARCADERO LOCAL: This flag marks a struct as being a Delphi return
   type.  */
#define TYPE_FLAG_DELPHI_RETURN (1 << 21)
#define TYPE_DELPHI_RETURN(t)       (TYPE_FLAGS (t) & TYPE_FLAG_DELPHI_RETURN)

/* EMBARCADERO LOCAL: This flag marks a function as adhering to the Delphi ABI.  */
#define TYPE_FLAG_DELPHI_ABI (1 << 22)
#define TYPE_DELPHI_ABI(t)       (TYPE_FLAGS (t) & TYPE_FLAG_DELPHI_ABI)

/* EMBARCADERO LOCAL: This flag marks Delphi dynamic array. */
#define TYPE_FLAG_DELPHI_DYNARRAY (1 << 23)
#define TYPE_DELPHI_DYNARRAY(t)       (TYPE_FLAGS (t) & TYPE_FLAG_DELPHI_DYNARRAY)

/* Not textual.  By default, GDB treats all single byte integers as
   characters (or elements of strings) unless this flag is set.  */

#define TYPE_FLAG_NOTTEXT	(1 << 24)
...
#define TYPE_PROP_FIELDS(thistype) TYPE_CPLUS_SPECIFIC_NONULL(thistype)->prop_fields
#define TYPE_NPROP_FIELDS(thistype) TYPE_CPLUS_SPECIFIC_NONULL(thistype)->nprop_fields
#define TYPE_PROP_FIELD(thistype, n) TYPE_CPLUS_SPECIFIC_NONULL(thistype)->prop_fields[n]
...
struct builtin_type
{
 ...
 /* EMBARCADERO LOCAL: FIXME: should merge with original trunk patch.  */
...
extern struct type *builtin_type_Delphi_char;   /* Delphi char */
