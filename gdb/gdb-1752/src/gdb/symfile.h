...
extern void add_dyld_shared_cache_local_symbols (struct objfile *objfile,
						 uint8_t *nlist_records_start,
						 int nlist_records_count,
						 int nlist_record_size,
						 char *strings_base,
						 CORE_ADDR slide, int mainline);
