 ...
 *
 *  Public header: http://www.theiphonewiki.com/wiki/index.php?title=MobileDevice_Library
 * ------------------------------------------------------------------------- */
...
#define AMSVC_SYSTEM_PROFILER       CFSTR("com.apple.mobile.system_profiler")
  ...
  } __PACK am_device_notification_callback_info;
  ...
  } __PACK am_bootloader_control_packet;
   ...
   */
   ...
   mach_error_t AMDeviceStartService(struct am_device *device, CFStringRef service_name, 
					service_conn_t *handle, unsigned int *unknown);

   mach_error_t AMDeviceSecureStartService(struct am_device *device, CFStringRef service_name, unsigned int *unknown, ServiceConnRef * handle);
  ...
  afc_error_t AFCFileRefSeek(struct afc_connection *conn, afc_file_ref ref,
                 unsigned long long offset, unsigned long long origin);
  ...
  */
  ...
  mach_error_t AMDeviceSecureTransferPath(int zero, AMDeviceRef device, CFURLRef url, 
                                           CFDictionaryRef options, void *callback, int cbarg);
  mach_error_t AMDeviceSecureInstallApplication(int zero, AMDeviceRef device, CFURLRef url, 
                                                CFDictionaryRef options, void *callback, int cbarg);
  mach_error_t AMDeviceSecureUninstallApplication(int zero, AMDeviceRef device, CFStringRef url, 
                                                CFDictionaryRef options, void *callback, int cbarg);
  mach_error_t AMDeviceMountImage(AMDeviceRef device, CFStringRef image, CFDictionaryRef options, 
                                   void *callback, int cbarg);
  mach_error_t AMDeviceLookupApplications(AMDeviceRef device, int zero, CFDictionaryRef* result);
...
*/
  ...
  mach_error_t AMDeviceActivate(struct am_device *device, CFMutableDictionaryRef dict);
