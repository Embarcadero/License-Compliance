...
uses
  SysUtils, Classes, Generics.Collections, IDESimpleParser, IDESimpleParser.Lexer,
  IDESimpleParser.Lexer.Types, IDEDelphiAST.Classes, IDEDelphiAST.Consts,
  IDEDelphiAST.SimpleParserEx;
...
begin
  if Typ = TMessageEventType.meError then
    OutputDebugString(PChar(EParserException.Create(Y, X, Lexer.FileName, Msg).Message));
